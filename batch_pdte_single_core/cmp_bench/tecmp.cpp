...
int main(int argc, char* argv[]){
    ...
    int n = l * m;
    EncryptionParameters parms = tecmp_init(n,l,m);
    ...
    clock_t start=clock();
    Ciphertext result = tecmp(evaluator, gal_keys_server, rlk_server, server_input, client_input, l, m,m_degree, one_zero_init_cipher);
