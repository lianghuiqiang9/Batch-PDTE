...
vector<uint64_t> rrcmp_encode_b(vector<uint64_t> b,int n, uint64_t slot_count,uint64_t row_count, uint64_t num_cmps_per_row);
vector<uint64_t> rrcmp_encode_a(vector<uint64_t> a,int n, uint64_t slot_count,uint64_t row_count, uint64_t num_cmps_per_row);
